...
It means its a simple attribute meaning NOT NULL

3. How many foreign keys does the "payments" table have? How can you tell?

There are 3 foreign keys. When you hover over the paymnets table it will show what other tables that are using the keys.
