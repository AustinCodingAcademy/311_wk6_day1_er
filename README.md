...
2. What does the blue diamond next to the "last_update" column on the "inventory" table represent? If it was unfilled it means NULL if its filled its NOT NULL

3. How many foreign keys does the "payments" table have? How can you tell? three, when you hover over the diagram it highlights green.
##### ER Diagram upload
