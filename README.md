...
The relationship between them is the "actor_id SMALL INT"

2. What does the blue diamond next to the "last_update" column on the "inventory" table represent?
The blue diamond next to the "last_update" column on the "inventory" table represents "Not Null"

3. How many foreign keys does the "payments" table have? How can you tell?
Payment has 3 forgein keys. I can tell because if I click payments and click on the foregin keys tab it tells me how many of therm there are.
