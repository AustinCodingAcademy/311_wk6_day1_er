...
3. How many foreign keys does the "payments" table have? How can you tell?
  3 Foreign Keys exist on this table. You can tell because the column is also referenced in a different table that shares a relationship with the payments table
