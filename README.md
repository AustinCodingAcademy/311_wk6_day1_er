...
1. What is the relationship between the "actor" and "film_actor" tables? - One mandatory to many mandatory
...
3. How many foreign keys does the "payments" table have? How can you tell? -18, all the red colored icons
