...
Being a filled blue diamond, means it is a NOT NULL simple attribute

3. How many foreign keys does the "payments" table have? How can you tell? 2, customer id and staff id.  The keys are red.
